...
**Scope:** Accounts Mode, UK launch, SQL build 4.1.4
...
| Structured statutory address | `Subject.tbAddressDetail` for the selected `AddressCode` | Ready | Reviewed synthetic structures pass on both active sandboxes; no parsing occurs during population. |
