...
namespace TradeControl.Web.Models
{
    ...
    public partial class Subject_tbAccount
    {
        ...
        [ForeignKey(nameof(BalanceConstraintCode))]
        [InverseProperty(nameof(Subject_tbBalanceConstraint.TbAccounts))]
        public virtual Subject_tbBalanceConstraint BalanceConstraintCodeNavigation { get; set; }
