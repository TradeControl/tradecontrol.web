CREATE TABLE [Cash].[tbChange] (
    ...
    CONSTRAINT [FK_Cash_tbChange_Org_tbAccountKey] FOREIGN KEY ([CashAccountCode], [HDPath]) REFERENCES [Org].[tbAccountKey] ([CashAccountCode], [HDPath]) ON DELETE CASCADE ON UPDATE CASCADE
);
